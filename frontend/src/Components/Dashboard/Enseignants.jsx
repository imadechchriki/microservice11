// src/components/Enseignants.jsx
...
export default function Enseignants() {
  ...
  const handleUpdate = (e) => {
    ...
    editTeacher(selectedTeacher.id, formData);
    setIsEditOpen(false);
    resetForm();
  };
  ...
  const handleDelete = () => {
    removeTeacher(selectedTeacher.id);
  ...
  const handleImport = async () => {
    ...
    try {
      await importTeachers(importFile);
                      ...
                      {filteredTeachers.length ? (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                <motion.div
                                  initial={false}
                                  animate={{ backgroundColor: profiles[teacher.id] ? "#10B981" : "#EF4444" }}
                                ...
                                <span className={`px-2 py-1 text-xs rounded-full ${
                                  ...
                                  {profiles[teacher.id] ? "Activé" : "Non activé"}
                                </span>
                              </div>
                            </td>
                        ...
                        <tr>
                          <td colSpan={5} className="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                            {filter ? "Aucun enseignant trouvé pour cette recherche" : "Aucun enseignant trouvé"}
                          </td>
                        </tr>
                      )}
                    </AnimatePresence>
              ...
              >
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">
                    Êtes-vous sûr de vouloir supprimer <strong>{selectedTeacher?.firstName} {selectedTeacher?.lastName}</strong> ?
