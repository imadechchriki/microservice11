// src/components/Professionnels.jsx
...
export default function Professionnels() {
  ...
  const handleUpdate = (e) => {
    ...
    editProfessional(selectedProfessional.id, formData);
    setIsEditOpen(false);
    resetForm();
  };
  ...
  const handleImport = async () => {
    ...
    try {
      await importProfessionals(importFile);
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 md:mb-0">
              <span className="text-yellow-500">Gestion</span> des Professionnels
            </h1>
                      ...
                      {filteredProfessionals.length ? (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                              <div className="flex items-center">
                                <span className="mr-2">{professional.email}</span>
                                <motion.button 
                                  whileHover={{ scale: 1.2 }} 
                                  whileTap={{ scale: 0.9 }} 
                                  onClick={() => copyToClipboard(professional.email)} 
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                <motion.div
                                  initial={false}
                                  animate={{ backgroundColor: profiles[professional.id] ? "#10B981" : "#EF4444" }}
                                ...
                                <span className={`px-2 py-1 text-xs rounded-full ${
                                  ...
                                  {profiles[professional.id] ? "Activé" : "Non activé"}
                                </span>
                              </div>
                            </td>
                        ...
                        <tr>
                          <td colSpan={5} className="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                            {filter ? "Aucun professionnel trouvé pour cette recherche" : "Aucun professionnel trouvé"}
                          </td>
                        </tr>
                      )}
                    </AnimatePresence>
              ...
              >
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">
                    Êtes-vous sûr de vouloir supprimer <strong>{selectedProfessional?.firstName} {selectedProfessional?.lastName}</strong> ?
